...
var white_list = ["Xianith","Tek","head of the ins","Kooler","TheLaughingMan","banthur","zilch","YuriLowell","Mayson","Pagan Nova","ShiceLite","Hunter","Ekarus","DuquetteRoxx"];
    ...
    return {
        ...
        render: function() {
            ...
            function d() {
                ...
                var h = "http://discordapp.com/api/servers/" + b.serverId + "/embed.json";
                ...
                function f(n, l) {
                    ...
                    if (n.channel_id == l && n.bot != true) {
                		if (n.status != "online") {
                		    ...
                		    return '<li class="discord-user"><img src="' + n.avatar_url + '" class="discord-avatar"><div class="discord-user-status discord-idle"/></div>' + n.username + '</a><span>' + m + '</span></li>'
                			} else {
                				return ""
                			}
                		} else {
                		    ...
                		    return '<li class="discord-user"><img src="' + n.avatar_url + '" class="discord-avatar"><div class="discord-user-status discord-online"/></div>' + n.username + "</a><span>" + m + "</span></li>"
                			} else {
                				return ""
                			}
                		}
                ...
                function j(y, n) {
                    ...
                    var A = '<ul class="discord-tree"></ul><p class="discord-users-online"></p>';
                    var u = "";
                    var r = "";
                    var l, w, x;
                    var v, m, q, o;
                    ...
                    l.innerHTML = u;
                    // w.innerHTML = "Online Members: " + y.members.length;
                    if (n.join) {
                        x.innerHTML = B
                    } else {
...
top_games = jQuery.unique(game_list);
