            ...
            function d() {
                ...
                function f(n, l) {
                    ...
                    if (n.channel_id == l && n.bot != true) {
                        if (n.status != "online") {
                            return '<li class="discord-user"><img src="' + n.avatar_url + '" class="discord-avatar discord-idle"/></div>' + n.username + "</a><span>" + m + "</span></li>"
                        } else {
                            ...
                            return '<li class="discord-user"><img src="' + n.avatar_url + '" class="discord-avatar discord-online"/></div>' + n.username + "</a><span>" + m + "</span></li>"
                        }
                    } else {
                        return ""
                    }
