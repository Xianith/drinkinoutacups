                ...
                function f(n, l) {
                    ...
                    if (n.channel_id == l && n.bot != true) {
                        if (n.status != "online") {
                            ...
                            return '<li class="discord-user"><img src="' + n.avatar_url + '" class="discord-avatar"></div><a href="'+ user_list[local].steam +'" title="'+user_list[local].role+'" style = "color:'+roleStyle+' !important">' + n.username + '</a></a></li>'
                            } else {
                                return ""
                            }
                        } else {
